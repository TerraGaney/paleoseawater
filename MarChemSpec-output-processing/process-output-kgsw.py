...
class GenerateTableEntry():
    ...
    def CalculateKs(self, tempC):
        ...
        K_MCS_modern_25 = [0.028569738,1.40726E-06,1.05656E-09,2.48912E-09,5.95452E-14,4.10235E-07,6.22674E-07,0.098327726]
        K_MCS_modern_0 = [0.063279232,7.61085E-07,4.01493E-10,1.20493E-09,4.87023E-15,4.11325E-07,6.56165E-07,0.282436643]
        if tempC == 25:
    ...
    def TableEntry(self, comptype, tempC):
        ...
        self.Column = pd.DataFrame(data, columns=[comptype], index=['pK0','pK1','pK2','pKB','pKH2O','pKspC','pKspA','pKHSO4','TempC','SalA','Ca2+ (total)','Mg2+ (total)','SO42- (total)','Na+','Cl-','IonicStr','pHF','pHT','ALK','DIC','Omega','alpha H','alpha CO3','alpha OH','pCO2'])
